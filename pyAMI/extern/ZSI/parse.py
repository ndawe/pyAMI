...
from pyAMI.extern.ZSI import _copyright, _children, _attrs, _child_elements, \
        _stringtypes, _backtrace, EvaluateException, ParseException, \
        _valid_encoding, _Node, _find_attr, _resolve_prefix
from pyAMI.extern.ZSI.TC import AnyElement
import types
...
class ParsedSoap:
    ...
    trailers=False, resolver=None,  envelope=True, **kw):
        ...
        try:
            self.dom = minidom.parseString(input)

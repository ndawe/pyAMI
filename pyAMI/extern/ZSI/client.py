...
from pyAMI.extern.ZSI.auth import AUTH
from pyAMI.extern.ZSI.TC import AnyElement, AnyType, String, TypeCode, _get_global_element_declaration,\
    _get_type_definition
from pyAMI.extern.ZSI.TCcompound import Struct
import base64, httplib, Cookie, types, time, urlparse
from pyAMI.extern.ZSI.address import Address
